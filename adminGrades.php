...
$result2 = mysqli_query($link, "SELECT * FROM tasks") or die("Ошибка " . mysqli_error($link));
$result3 = mysqli_query($link, "SELECT * FROM students") or die("Ошибка " . mysqli_error($link)); 
if($result)
{
	...
	for ($i = 0 ; $i < $rows ; ++$i)
	{
		...
		<button onclick='deleteGrade(".$row['id'].")' class='btn btn-danger btn-sm' data-toggle='modal' data-target='#Delete'>Удалить</button>
		</td>";
		echo "</tr>";
	}
	echo "</table>";
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
							...
							<div class="form-group">
                                <input type="hidden" class="form-control" id="id" name="gr_id">
...
$link = mysqli_connect($host, $user, $password, $database) 
    or die("Ошибка " . mysqli_error($link));
	  ...
	  $result2 = mysqli_query($link, "SELECT * FROM students") or die("Ошибка " . mysqli_error($link)); 
if($result2)
{
	$rows2 = mysqli_num_rows($result2);
	for ($i = 0 ; $i < $rows2 ; ++$i){
