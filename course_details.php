    ...
    height="35">
        ...
        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
          ...
          <a class="dropdown-item" href="#"><i class="fa fa-wrench"></i> Настройки</a>
            <div class="dropdown-divider"></div>
            <a class="dropdown-item" href="auth.php" ><i class="fa fa-sign-out"></i> Выход</a>
      ...
      <div class="card mt-3 mb-3" id="header_card">
          ...
          <ol class="breadcrumb" style="background-color: white">
            <li class="breadcrumb-item"><a href="home.html">В начало</a></li>
            <li class="breadcrumb-item"><a href="teacherTasks.php">Мои курсы</a></li>
            <li class="breadcrumb-item active" aria-current="page">11645</li>
          </ol>
        </nav>
            </div>
                </div>
    ...
    <div class="container-fluid" >
      <div class="row">
          ...
          <div class="container">
              ...
              <div class="row">
              <ul class="list-group list-group-flush list-fluid">
