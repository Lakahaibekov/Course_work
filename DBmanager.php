...
<?php
require_once 'connection.php';
if(isset($_POST['grgrade']) && isset($_POST['gr_date']) && isset($_POST['gr_task_id']) && isset($_POST['gr_student_id'])){
    ...
    $query ="INSERT INTO grades VALUES(NULL, '$grade', '$date', '$task_id','$student_id')";
...
if(isset($_POST['gr_grade']) && isset($_POST['gr_date']) && isset($_POST['gr_task_id']) && isset($_POST['gr_student_id']) && isset($_POST['gr_id']) ){
 
    $grade = htmlentities(mysqli_real_escape_string($link, $_POST['gr_grade']));
    $date = htmlentities(mysqli_real_escape_string($link, $_POST['gr_date']));
    $task_id = htmlentities(mysqli_real_escape_string($link, $_POST['gr_task_id']));
    $student_id = htmlentities(mysqli_real_escape_string($link, $_POST['gr_student_id']));
	$id = htmlentities(mysqli_real_escape_string($link, $_POST['gr_id']));
