...
mysqli_close($link);
 ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="teacherid" id="teacher_id">
																	 <?php
 require_once 'connection.php';
$link = mysqli_connect($host, $user, $password, $database) 
    or die("Ошибка " . mysqli_error($link));

	  $result2 = mysqli_query($link, "SELECT * FROM teachers") or die("Ошибка " . mysqli_error($link)); 
if($result2)
{
	$rows2 = mysqli_num_rows($result2);
	for ($i = 0 ; $i < $rows2 ; ++$i){
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">	
							...
							<div class="form-group">
								...
								<div class="form-group">
                                    <label class="col-form-label" >Course:</label>
								<select class="form-control" name="task_course_id" id="course_id">
...
mysqli_close($link);
 ?>
							...
							<div class="form-group">
                                    <label class="col-form-label" >Teachers:</label>
								<select class="form-control" name="task_teacher_id" id="teacher_id">
																	 <?php
 require_once 'connection.php';
$link = mysqli_connect($host, $user, $password, $database) 
    or die("Ошибка " . mysqli_error($link));
